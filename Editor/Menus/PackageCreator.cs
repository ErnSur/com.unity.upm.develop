...
namespace Unity.PackageManagerUI.Develop.Editor
{
    internal static class PackageCreator    
    {
        ...
        public static string CreatePackage(string path)
        {
            ...
            var companyAndDisplayName = path.Substring(packagesFolder.Length);
            var names = companyAndDisplayName.Split('.');
            var options = CreatePackageTemplateOptions(names[1], names[0]);
